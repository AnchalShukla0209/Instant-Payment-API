namespace InstantPay.Application.Interfaces.FinoAeps
{
    public interface IFinoAepsTransactionService
    {
        ...
        Task UpdateWithCommissionAsync(string txnId, string status, string? apiRes, FinoAepsCommission commission, decimal newBal, string RRN, bool onUs = false, decimal requestedamount = 0, CancellationToken ct = default);
    }
}
