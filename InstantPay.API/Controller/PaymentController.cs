...
namespace InstantPay.API.Controller
{
    ...
    public class PaymentController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll([FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 10,
            [FromQuery] string status = null, [FromQuery] string? fromDate = null, [FromQuery] string? toDate = null, [FromQuery] string commonsearch ="", [FromQuery] int isExport=0, [FromQuery] int userid=0)
        {
            try
            {
                var userId = Request.Headers["userid"].FirstOrDefault();
                ...
                var result = await _paymentService.GetAllPaymentsAsync(pageNumber, pageSize, status, fromDate, toDate, commonsearch, isExport, userid);
