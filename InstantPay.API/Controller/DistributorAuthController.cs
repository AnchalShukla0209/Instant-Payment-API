...
[ApiController]
[AllowAnonymous]
[Route("api/v1/distributor/auth")]
[Produces("application/json")]
public sealed class DistributorAuthController : ControllerBase
{
    private readonly IDistributorAuthService _authService;

    public DistributorAuthController(IDistributorAuthService authService)
    {
    ...
    [ProducesResponseType<DistributorLoginChallengeResponse>(StatusCodes.Status200OK)]
    ...
    [ProducesResponseType<DistributorTokenResponse>(StatusCodes.Status200OK)]
    [ProducesResponseType<ProblemDetails>(StatusCodes.Status400BadRequest)]
    [ProducesResponseType<ProblemDetails>(StatusCodes.Status401Unauthorized)]
    [ProducesResponseType<ProblemDetails>(StatusCodes.Status429TooManyRequests)]
